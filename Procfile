...
clock: java $JAVA_OPTS -Dspring.profiles.active=prod -Dio.iconator.commons.amqp.url=$AMQP_URL -Dio.iconator.commons.mail.service.host=email-smtp.us-east-1.amazonaws.com -Dio.iconator.commons.mail.service.admin=eureka@sciencematters.io -jar services/email/build/libs/email.jar
