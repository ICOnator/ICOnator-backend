...
import io.iconator.backend.controller.exceptions.AuthorizationHeaderMissingException;
import io.iconator.backend.controller.exceptions.AvailableKeyPairNotFoundException;
import io.iconator.backend.controller.exceptions.BaseException;
import io.iconator.backend.controller.exceptions.BitcoinAddressInvalidException;
import io.iconator.backend.controller.exceptions.ConfirmationTokenNotFoundException;
import io.iconator.backend.controller.exceptions.EthereumAddressInvalidException;
import io.iconator.backend.controller.exceptions.EthereumWalletAddressEmptyException;
import io.iconator.backend.controller.exceptions.UnexpectedException;
import io.iconator.backend.controller.exceptions.WalletAddressAlreadySetException;
